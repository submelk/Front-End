            ...
            >
              <div className="border-b-2 border-b-[#F7F8FC] pb-9 mb-12 -mx-9 px-9">
                ...
                <p className="text-sm leading-10 font-medium text-justify">
                  ...
                  اجرا و استقرار بناهای جدید بوده و به منظور انجام کار، تخریب
                  آنها ضروری است، باید با نظر کارفرما طبق دستورات دستگاه نظارت
                  اندازهگیری، صورتمجلس و تخریب شوند. این موارد باید در مشخصات
                  فنی خصوصی ذکر گردند. قبل از شروع به تخریب ساختمانها باید مسائل
                  ایمنی و اصول فنی در مورد قطع و کنترل انشعابات خطوط آب، برق،
                  تلفن و ... با هماهنگی سازمانهای مسئول مراعات گردد. در صورت
                  لزوم باید مصالح حاصل از تخریب مطابق نظر دستگاه نظارت دستهبندی
                  و در محلهای مناسب انبار شوند.
                </p>
                <div className="flex items-center flex-wrap mt-8 gap-4 font-medium text-sm">
                  {[...Array(9)].map((item, indx) => (
                    <div
                      key={indx}
                      className="bg-[#F4F4F4] rounded-lg px-3 py-2"
                    >
                      اسکلت بتنی
                    </div>
                  ))}
            ...
            >
              <div className="">
                ...
                <div>
                  ...
                  <div className="my-8 font-bold text-sm">
                    گزارش کامل دی ۱۴۰۱
                  </div>
