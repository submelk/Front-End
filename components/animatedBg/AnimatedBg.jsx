    ...
    >
      <g data-name="Layer 2">
        <g data-name="Layer 1">
          ...
          <path
            ref={curve2}
            className={`firstLine curveD2 ${isVisiblecurve2 ? "active" : ""}`}
          ...
          <path
            ref={curve1}
            className={`firstLine curveD1 ${isVisiblecurve1 ? "active" : ""}`}
          ...
          <path
            ref={curve3}
            className={`firstLine curveD3 ${isVisiblecurve3 ? "active" : ""}`}
          ...
          <path
            ref={curve4}
            className={`firstLine curveD4 ${isVisiblecurve4 ? "active" : ""}`}
          ...
          <path
            ref={line1}
            className={`firstLine lineD1 ${isVisibleline1 ? "active" : ""}`}
            d="M202 0H998V7H202z"
          ></path>
          <path
            ref={line2}
            className={`firstLine lineD2 ${isVisibleline2 ? "active" : ""}`}
            d="M202 137H802V144H202z"
          ></path>
          <path
            ref={line3}
            className={`firstLine lineD3 ${isVisibleline3 ? "active" : ""}`}
            d="M202 274H802V281H202z"
          ></path>
          ...
          <path
            ref={curve5}
            className={`firstLine curveD5 ${isVisiblecurve5 ? "active" : ""}`}
          ...
          <path
            ref={curve6}
            className={`firstLine curveD6 ${isVisiblecurve6 ? "active" : ""}`}
          ...
          <path
            ref={curve7}
            className={`firstLine curveD7 ${isVisiblecurve7 ? "active" : ""}`}
          ...
          <path
            ref={curve8}
            className={`firstLine curveD8 ${isVisiblecurve8 ? "active" : ""}`}
          ...
          <path
            ref={curve9}
            className={`firstLine curveD9 ${isVisiblecurve9 ? "active" : ""}`}
          ...
          <path
            ref={curve10}
            className={`firstLine curveD10 ${isVisiblecurve10 ? "active" : ""}`}
          ...
          <path
            ref={curve11}
            className={`firstLine curveD11 ${isVisiblecurve11 ? "active" : ""}`}
          ...
          <path
            ref={curve12}
            className={`firstLine curveD12 ${isVisiblecurve12 ? "active" : ""}`}
          ...
          <path
            ref={curve13}
            className={`firstLine curveD13 ${isVisiblecurve13 ? "active" : ""}`}
          ...
          <path
            ref={curve14}
            className={`firstLine curveD14 ${isVisiblecurve14 ? "active" : ""}`}
          ...
          <path
            ref={curve15}
            className={`firstLine curveD15 ${isVisiblecurve15 ? "active" : ""}`}
          ...
          <path
            ref={line9}
            className={`firstLine lineD9 ${isVisibleline9 ? "active" : ""}`}
            d="M0 1095H796V1102H0z"
          ></path>
          <path
            ref={line4}
            className={`firstLine lineD4 ${isVisibleline4 ? "active" : ""}`}
            d="M202.47 958.68H802.47V965.68H202.47z"
          ></path>
          <path
            ref={line5}
            className={`firstLine lineD5 ${isVisibleline5 ? "active" : ""}`}
            d="M202.47 684.68H802.47V691.68H202.47z"
          ></path>
          <path
            ref={line6}
            className={`firstLine lineD6 ${isVisibleline6 ? "active" : ""}`}
            d="M202.47 821.68H802.47V828.68H202.47z"
          ></path>
          <path
            ref={line7}
            className={`firstLine lineD7 ${isVisibleline7 ? "active" : ""}`}
            d="M202.47 410.88H802.47V417.88H202.47z"
          ></path>
          <path
            ref={line8}
            className={`firstLine lineD8 ${isVisibleline8 ? "active" : ""}`}
