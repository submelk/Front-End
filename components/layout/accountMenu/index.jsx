...
const AccountMenu = () => {
  ...
  return (
    <div className="border-l-4 border-[#EDEEF2] pl-4 w-[272px] min-w-[272px] -my-4 hidden lg:block">
      <Image
      ...
      <div className="flex items-center justify-center gap-4 border-b border-[#EDEEF2] pb-9 mb-6">
        <div className="text-sm text-[#5D6F7E] font-medium">موجودی کیف پول</div>
        ...
        <ul className="text-[#173046]">
          <li>
            <Link
              ...
              className={`flex items-center gap-3 py-3 px-7 font-semibold ${
                asPath === "/account/personal/" ? "activePage" : ""
              }`}
            >
              <svg
                width="25"
          ...
          <li className="mt-3">
            <Link
              href="/account/terms/"
              className={`flex items-center gap-3 py-3 px-7 font-semibold ${
                asPath === "/account/terms/" ? "activePage" : ""
              }`}
            >
              <svg
                width="25"
          ...
          <li className="mt-3">
            <Link
              href="/account/wallet/"
              className={`flex items-center gap-3 py-3 px-7 font-semibold ${
                asPath === "/account/wallet/" ? "activePage" : ""
              }`}
            >
              <svg
                width="25"
          ...
          <li className="mt-3">
            <Link
              href="/account/mySubs/"
              className={`flex items-center gap-3 py-3 px-7 font-semibold ${
                asPath === "/account/mySubs/" ? "activePage" : ""
              }`}
            >
              <svg
                width="25"
          ...
          <li className="mt-3">
            <Link
              href="/account/subs/"
              className={`flex items-center gap-3 py-3 px-7 font-semibold ${
                asPath === "/account/subs/" ? "activePage" : ""
              }`}
            >
              <svg
                width="25"
